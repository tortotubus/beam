...
/**
 * @brief Force-coupled immersed-boundary wrapper for @ref RigidBodyFibre.
 */
class IBRigidBodyFibre
  : public IBForceCoupled
  , public RigidBodyFibre
{
public:
  using Vec3 = RigidBodyModel::Vec3;
  using Quat = std::array<real_t, 4>;
  using RigidBodyFibre::mesh;

  IBRigidBodyFibre(real_t length,
                   real_t diameter,
                   size_t nodes,
