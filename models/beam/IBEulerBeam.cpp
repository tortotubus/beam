...
void
IBEulerBeam::ComputeNextPoints(std::vector<IBMesh::IBVertex> force, real_t dt)
{
...
void
IBEulerBeam::pack_state(IBModelState& s) const
{
...
void
IBEulerBeam::unpack_state(const IBModelState& s)
{
  static constexpr int64_t state_version = 1;
