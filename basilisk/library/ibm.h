...
#define PERIODIC_1DIST(a, b)                                                   \
  (fabs(a - L0 - b) > L0 / 2. ? a + L0 - b : a - L0 - b)
#define GENERAL_1DIST(a, b)                                                    \
  (ACROSS_PERIODIC(a, b) ? PERIODIC_1DIST(a, b) : a - b)
#define PERIODIC_1DAVG(a, b)                                                   \
  (fabs(a - L0 - b) > L0 / 2. ? a + L0 + b : a - L0 + b)
#define GENERAL_1DAVG(a, b)                                                    \
  (ACROSS_PERIODIC(a, b) ? PERIODIC_1DAVG(a, b) : a + b)
