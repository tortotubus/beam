...
typedef struct {
  ...
  int mesh_gid; /**< Stable logical mesh identity. */
  int node_lid; /**< Stable node id within the logical mesh. */
  int touched_epoch; /**< Sparse-node liveness marker. */
} IBNode;
