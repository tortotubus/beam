...
#include "c/ibm/immersedboundary.h"
#include "models/ibm/IBVelocityCoupled.hpp"
#include <stdlib.h>

// using ELFF::IBForceCoupled;
// using ELFF::IBMesh;
// using ELFF::IBVelocityCoupled;
...
extern "C"
{
  ...
  /* ==================================================================================================================
   * Wrappers for ELFF::Models::IBMesh
   * ==================================================================================================================
   */
  ...
  /* ==================================================================================================================
   * Wrappers for ELFF::Models::IBVelocityCoupled
   * ==================================================================================================================
   */
  ...
  /* ================================================================================================================== 
   * Wrappers for ELFF::Model::IBForceCoupled
   * ==================================================================================================================
   */
  ...
  {
    IBForceCoupled* model =
      reinterpret_cast<IBForceCoupled*>(handle);
