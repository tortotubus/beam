...
experiment. %TODO: Cite example(s) here 
At low Reynolds number, the slender geometry of a fibre motivates
...
constraint. The fluid and fibre are coupled together by a kinematic no-slip condition: the
velocity of the fibre centerline must agree with the local fluid velocity, and
the discrete force needed to enforce this condition is applied both to the fluid and the fibre.
...
The central modelling trade-off is between fidelity and cost. A finite surface- or
