...
// TEST(EulerBeamStaticInextensibleADDMTest, BourgatDumayGlowinski) {
//   real_t length = 32.6, EI = 7000., mu = 1., r_pentalty = 1e3; 
//   std::array<real_t, 3> load = {0.,-9.81*7.67,0.};
//   size_t nodes = 50;

//   EulerBeamBCs boundary_conditions = {
//     .end = {left, right},
//     .type = {clamped_bc, clamped_bc},
//     .vals = {{
//       .position = {0,0,0},
//       .slope = {1,0,0}
//     }, {
//       .position = {length-length*.09,0,0},
//       .slope = {1,0,0}
//     }}
//   };
